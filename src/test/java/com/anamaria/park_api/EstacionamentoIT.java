...
public class EstacionamentoIT {
    ...
    public void criarCheckin_ComDadosValidos_RetornarCreatedAndLocation() {
        ...
        testClient
                ...
                .headers(JwtAuthentication.getHeaderAutorization(testClient, "ana@email.com.br", "123456"))
                .bodyValue(createDto)
                .exchange()
    ...
    public void criarCheckin_ComRoleCliente_RetornarErrorStatus403() {
        ...
        testClient.post().uri("/api/v1/estacionamentos/check-in")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAutorization(testClient, "maria@email.com.br", "123456"))
                .bodyValue(createDto)
                .exchange()
    ...
    public void criarCheckin_ComCpfInexistente_RetornarErrorStatus404() {
        EstacionamentoCreateDTO createDto = EstacionamentoCreateDTO.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("33838667000")//cpf n pertence a nenhum cliente
                .build();
    ...
    @Sql(scripts = "/sql/estacionamentos/estacionamento-insert-vagas-ocupadas.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)//sqls locais
    ...
    @Test
    public void criarCheckin_ComVagasOcupadas_RetornarErrorStatus404() { //todas as vagas estao ocupadas
        EstacionamentoCreateDTO createDto = EstacionamentoCreateDTO.builder()
                .placa("WER-1111").marca("FIAT").modelo("PALIO 1.0")
                .cor("AZUL").clienteCpf("09191773016")
                .build();
    ...
    public void buscarCheckin_ComPerfilAdmin_RetornarDadosStatus200() {
        ...
        testClient.get()
                .uri("/api/v1/estacionamentos/check-in/{recibo}", "20230313-101300")//numero de um recibo
                .headers(JwtAuthentication.getHeaderAutorization(testClient, "ana@email.com.br", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody()//todas as informações pq é um retorno com isOk/200
    ...
    @Test
    public void buscarCheckin_ComReciboInexistente_RetornarErrorStatus404() {// Recibo Inexistente

        testClient.get()
                .uri("/api/v1/estacionamentos/check-in/{recibo}", "20230313-999999")//recibo invalido
                .headers(JwtAuthentication.getHeaderAutorization(testClient, "sid@email.com.br", "123456"))
                .exchange()
                .expectStatus().isNotFound()
                .expectBody()
                .jsonPath("status").isEqualTo("404")
    ...
    public void criarCheckOut_ComReciboExistente_RetornarSucesso() {
        ...
        testClient
                .put()
                .uri("/api/v1/estacionamentos/check-out/{recibo}", "20230313-101300")//recibo valido
                .headers(JwtAuthentication.getHeaderAutorization(testClient, "ana@email.com.br", "123456"))
                .exchange()
                .expectStatus().isOk()
                .expectBody()
