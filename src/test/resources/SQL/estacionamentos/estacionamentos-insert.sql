...
insert into USUARIOS (id, username, password, role)
    values (101, 'maria@email.com.br', '$2a$10$AtWo422MdyRQ1RgPzmJNnuDB7xN0GW38sXT4rnBFBqGnMyVmVEf4O', 'ROLE_CLIENTE');
insert into USUARIOS (id, username, password, role)
    values (102, 'sid@email.com.br', '$2a$10$AtWo422MdyRQ1RgPzmJNnuDB7xN0GW38sXT4rnBFBqGnMyVmVEf4O', 'ROLE_CLIENTE');

insert into CLIENTES (id, nome, cpf, id_usuario) values (21, 'Ana maria', '09191773016', 101);
insert into CLIENTES (id, nome, cpf, id_usuario) values (22, 'Maria alves', '98401203015', 102);
